...
(function () {
  ...
  function cardHTML(a) {
    ...
    <article class="group bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
      <a href="/artikel-detail?slug=" class="block h-48 bg-slate-100 dark:bg-slate-700 overflow-hidden flex-shrink-0">
      ...
      <div class="p-5 flex flex-col flex-1">
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 line-clamp-3 mb-4 flex-1"></p>
